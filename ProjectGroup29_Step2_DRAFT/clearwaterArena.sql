...
--
-- Host: localhost
-- Generation Time: Jul 12, 2022 at 02:23 AM
...
INSERT INTO `Fans` (`fanID`, `firstName`, `lastName`, `email`, `phoneNumber`, `streetAddress`, `city`, `state`, `zipCode`, `Concerts_concertID`) VALUES
...
INSERT INTO `Tickets` (`ticketID`, `Concerts_concertID`, `Fans_fanID`) VALUES
(1, 6, 4),
(2, 6, 1),
(3, 3, 3),
(4, 3, 4),
...
ALTER TABLE `Fans`
  ...
  ADD KEY `fk_Customers_Concerts1_idx` (`Concerts_concertID`);

--
-- Indexes for table `Tickets`
--
ALTER TABLE `Tickets`
  ADD PRIMARY KEY (`ticketID`,`Concerts_concertID`,`Fans_fanID`),
  ADD KEY `fk_Tickets_Concerts1_idx` (`Concerts_concertID`),
  ADD KEY `fk_Tickets_Fans1_idx` (`Fans_fanID`);
